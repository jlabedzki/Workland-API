...
const model = __importStar(require("../models/message"));
function getDirectMessages(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const receiver_id = 2;
        const queryResult = yield model.getDirectMessages(receiver_id);
        res.send(queryResult.rows.map((row) => (0, camelcase_keys_1.default)(row)));
    });
}
exports.getDirectMessages = getDirectMessages;
;
function getGlobalMessages(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const queryResult = yield model.getGlobalMessages();
        res.send(queryResult.rows.map((row) => (0, camelcase_keys_1.default)(row)));
    });
}
