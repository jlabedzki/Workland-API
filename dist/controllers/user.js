...
const model = __importStar(require("../models/user"));
function getAllUsers(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const queryResult = yield model.getAllUsers();
        res.send(queryResult.rows.map((row) => (0, camelcase_keys_1.default)(row)));
    });
}
exports.getAllUsers = getAllUsers;
;
function getUsersByProjectID(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const project_id = parseInt(req.params.projectID);
        const queryResult = yield model.getUsersByProjectID(project_id);
        res.send(queryResult.rows.map((row) => (0, camelcase_keys_1.default)(row)));
    });
}
